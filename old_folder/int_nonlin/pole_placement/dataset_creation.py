...
# Desired poles for the closed-loop system in discrete time
desired_poles = np.array([0.6, 0.7, 0.8])

# Compute the state feedback gains using pole placement in discrete time
K = control.place(A, B, desired_poles)

print("State feedback gains K:", K)

eigvals = np.linalg.eigvals(A - B @ K)
print("Eigenvalues of the closed-loop system:", eigvals)
